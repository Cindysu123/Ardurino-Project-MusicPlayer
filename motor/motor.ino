...
void motorOnThenOffWithSpeed(){
  ...
  int onSpeed = 225;  // a number between 0 (stopped) and 255 (full speed) 
  int onTime = 7;  //the number of milliseconds for the motor to turn on for
  
  int offSpeed = 0;  // a number between 0 (stopped) and 255 (full speed) 
  int offTime = 35; //the number of milliseconds for the motor to turn off for
